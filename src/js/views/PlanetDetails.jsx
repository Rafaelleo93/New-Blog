    ...
    <div className="container">
      ...
      <div className="container row border-top border-danger mt-4 text-capitalize">
        <div className="col-2 text-danger text-center">
          <b>Name:</b>
          <p><em>{store.planet[params.id - 1].name}</em></p>
        </div>
        <div className="col-2 text-danger text-center">
          <b>Rotation period:</b>
          <p><em>{store.planet[params.id - 1].rotation_period}</em></p>
        </div>
        <div className="col-2 text-danger text-center">
          <b>Orbital period:</b>
          <p><em>{store.planet[params.id - 1].orbital_period}</em></p>
        </div>
        <div className="col-2 text-danger text-center">
          <b>Diameter:</b>
          <p><em>{store.planet[params.id - 1].diameter}</em></p>
        </div>
        <div className="col-2 text-danger text-center">
          <b>Climate:</b>
          <p><em>{store.planet[params.id - 1].climate}</em></p>
        </div>
        <div className="col-2 text-danger text-center">
          <b>Gravity:</b>
          <p><em>{store.planet[params.id - 1].gravity}</em></p>
        </div>
      </div>
      <br />
      <Link to="/">
